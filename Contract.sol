/**
  ...
  ______             _                 _           _       _                       
 |  ____|           | |               (_)         | |     (_)                      
 | |__ _ __ ___  ___| |__   __ _  __ _ _ _ __  ___| |_ ___ _ _ __         ___ ___  
 |  __| '__/ _ \/ __| '_ \ / _` |/ _` | | '_ \/ __| __/ _ \ | '_ \       / __/ _ \ 
 | |  | | |  __/\__ \ | | | (_| | (_| | | | | \__ \ ||  __/ | | | |  _  | (_| (_) |
 |_|  |_|  \___||___/_| |_|\__, |\__,_|_|_| |_|___/\__\___|_|_| |_| (_)  \___\___/ 
                            __/ |                                                  
                           |___/                                                  

 Total Supply: 1.000.000.000
 7% Rewards between holders with top gainer coin on CoinMarketCap of the day!
 8% Automatic liquidity to stabilize price floor
 5% Marketing wallet
...
contract Freshgainstein is IBEP20, Auth, TokensRescuer {
    ...
    uint256 public _maxTxAmount = _totalSupply / 99; // 1%
    uint256 public maxWalletSize = _totalSupply / 49; // 2%

    bool public swapEnabled = true;
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    bool priceImpactCheckEnabled = false;
    uint256 priceImpactNumerator = 10000;
    uint256 maxPriceImpact = 333; // 3.33% by default

    mapping (address => uint256) txHistory;
    uint256 public txCooldown = 5 seconds;
    bool public isCooldownActive = false;
    ...
    constructor(
        ...
        if (_rewards_token == address(0)) {
            distributor = new DividendDistributor(address(router), 0x55d398326f99059fF775485246999027B3197955); // USDT by default
        } else {
